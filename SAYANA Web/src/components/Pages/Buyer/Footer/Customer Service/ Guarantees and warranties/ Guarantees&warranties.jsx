  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-xl shadow mt-8">
      ...
      <p className="mt-6 text-gray-600">
        Please read our <a href="/buyer/terms" className="text-[#003664] underline">Terms and Conditions</a> for more information.
      </p>
    </div>
  );
}

export default GuaranteesWarranties;