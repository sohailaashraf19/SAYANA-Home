  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-xl shadow mt-8">
      ...
      <ul className="list-disc pl-6 mb-4 text-gray-800 space-y-2">
        ...
        <li>
          <strong>Returns &amp; Exchanges:</strong> If you’re not satisfied, you can return or exchange items according to our <a href="/buyer/return-policy" className="text-[#003664] underline">return policy</a>.
        </li>
        <li>
          <strong>Shopping Tips:</strong> Need advice? Check our <a href="/buyer/FAQ" className="text-[#003664] underline">FAQ</a> or contact us directly!
        </li>
      </ul>
