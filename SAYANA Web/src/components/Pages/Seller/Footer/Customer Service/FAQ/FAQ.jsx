    ...
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-xl shadow mt-8">
      ...
      <div className="space-y-6 text-gray-800">
        ...
        <div>
          ...
          <p>
            Most items can be returned within 14 days of receipt if they are unused and in original packaging. Please read our <a href="return-policy-seller" className="text-[#003664] underline">Return Policy</a> for full details.
          </p>
        </div>
        <div>
