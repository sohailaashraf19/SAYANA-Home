  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-xl shadow mt-8">
      ...
      <ul className="list-disc pl-6 mb-4 text-gray-800 space-y-2">
        ...
        <li>
          <strong>Returns &amp; Exchanges:</strong> If you are not fully satisfied, you can return or exchange items according to our <a href="return-policy-seller" className="text-[#003664] underline">return policy</a>.
        </li>
      </ul>
...
export default AboutServicesSeller;