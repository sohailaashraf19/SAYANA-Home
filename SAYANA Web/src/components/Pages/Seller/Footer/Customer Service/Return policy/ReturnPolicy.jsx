  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-xl shadow mt-8">
      ...
      <p className="mt-4 text-gray-600">
        For more details, please read our <a href="terms-seller" className="text-[#003664] underline">Terms and Conditions</a> or contact our support team for assistance.
      </p>
    </div>
  );
}

export default ReturnPolicySeller;